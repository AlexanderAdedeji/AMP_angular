...
@Component({
  ...
  styleUrls: ['./all-officers.component.css']
})
export class AllOfficersComponent implements OnInit {
  AllAgentsData;
  AllUsersData;
  isSuperUser:boolean;
  isManager:boolean;
  ...
  search(){
    const data= this.OfficerDetails.filter(user=>user.lasrra_id.includes(this.searchedItem) || user.phone.includes(this.searchedItem)|| user.first_name.includes(this.searchedItem) || (user.first_name + ' ' + user.last_name).includes(this.searchedItem) || (user.first_name + '' + user.last_name).includes(this.searchedItem) || user.last_name.includes(this.searchedItem) || user.email.includes(this.searchedItem))
  ...
  GetAllUsers(){
    this.OfficerDetails = this.storageService.AllAgentUsersData;
